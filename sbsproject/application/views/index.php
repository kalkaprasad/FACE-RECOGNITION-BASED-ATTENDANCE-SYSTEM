...
<!--  login form	 -->
<form method="post"action="<?php echo base_url();?>index.php/Admin/logincheck">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
  <select class="form-control" select name="options" aria-label="Default select example" required>
