...
<div class="row">
  <div class="col-4">
    <!-- New Admition -->
    <a href="https://play.google.com/apps/publish"target="blanck">
<div class="card" id="card1"style="width: 18rem;background-color:dark">
  <div class="card-body">
  <center> <img src="<?php echo base_url("assests/image/playconsole.png")?>"id="imgIcon"></center>

   <center><p class="card-text">Open Play Console</p></center> 
  </div>
  </div>
</div>
